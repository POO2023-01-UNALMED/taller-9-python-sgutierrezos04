...
def press(evento):
    ...
    pantalla.insert('end', str(pact) + str(evento.widget["text"]))


def igual(evento):
    calcular = pantalla.get()
    result = eval(calcular)
    pantalla.delete(0, 'end')
    pantalla.insert('end', str(result))

boton_1.bind("<Button-1>", press)
boton_2.bind("<Button-1>", press)
boton_3.bind("<Button-1>", press)
boton_4.bind("<Button-1>", press)
boton_5.bind("<Button-1>", press)
boton_6.bind("<Button-1>", press)
boton_7.bind("<Button-1>", press)
boton_8.bind("<Button-1>", press)
boton_9.bind("<Button-1>", press)
boton_igual.bind("<Button-1>", igual)
boton_punto.bind("<Button-1>", press)
boton_mas.bind("<Button-1>", press)
boton_menos.bind("<Button-1>", press)
boton_multiplicacion.bind("<Button-1>", press)
boton_division.bind("<Button-1>", press)
